...
## Project Structure
    ...
    ├── testapiautoteammemb_76868  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_76868`
...
2. Clone this repo and `cd testapiautoteammemb_76868`
